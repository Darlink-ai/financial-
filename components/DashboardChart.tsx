...
export function DashboardChart() {
  const { revenues, businesses, ready } = useStore();
  ...
  >({});
  // True tant que le fetch des sheets Excel n'a pas terminé. Combiné avec
  // `ready` du store, ça pilote le loader discret en haut à droite du chart.
  ...
  // Loader actif tant qu'on n'a pas (a) le store prêt (revenues chargés) et
  // (b) le calcul des dépenses Excel terminé. Discret : juste un petit point
  // qui pulse à côté du titre, pas de bandeau.
  const isLoading = !ready || loadingExpenses;
